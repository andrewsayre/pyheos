...
class SystemCommands:
    ...
    def check_account() -> HeosCommand:
        ...
        return HeosCommand(const.COMMAND_ACCOUNT_CHECK)
    ...
    def sign_out() -> HeosCommand:
        ...
        return HeosCommand(const.COMMAND_SIGN_OUT)
    ...
    def heart_beat() -> HeosCommand:
        ...
        return HeosCommand(const.COMMAND_HEART_BEAT)
    ...
    def reboot() -> HeosCommand:
        ...
        return HeosCommand(const.COMMAND_REBOOT)
